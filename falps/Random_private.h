...
//
// <b style="color:black;background-color:#ffff66">RandMT</b> class created by Paul Gresham 
...
public:
	...
	{
		static RandMT _rand__;return _rand__;
	}
};
//#endif // _RANDMT_H_
...
inline RandMT::RandMT(uint32 seed)
{
	seedMT(seed);
}

inline void RandMT::seedMT(uint32 seed)
{
	//
...
inline uint32 RandMT::reloadMT(void)
{
